...
<head>
    ...
    <title>Ayuda</title><!-- Título de la página -->
    ...
    <link rel="stylesheet" type="text/css" href="../public/css/ayuda.css"><!--Enlaza css Estilo ayuda-->
...
include '../views/ayuda.php';//Incluye vista ayuda
