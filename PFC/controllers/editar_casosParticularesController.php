...
<head>
    ...
    <title>Editar Casos Particulares</title><!-- Título de la página -->
 ...
 include '../models/editar_casosParticularesModel.php';//Incluye editar_casosParticularesModel, interacción con los datos
 include '../views/editar_casosParticulares.php';//Incluye vista editar_casosParticulares
