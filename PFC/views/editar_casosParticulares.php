...
<div class="container-fluid">
    <?php
    $volvercp=true;//Variable identificar la navegación de la página
    $title = "CASOS PARTICULARES";//Cabecera Casos particulares
    include('components/header.php');// Se incluye el archivo de la cabecera
    ?>
    <div class="row">
        <div class="col-lg-12">
            <h1>SEGUIMIENTO</h1><!--Título principal pde Seguimiento-->
            <form method="post" action=""><!--Formulario para realizar los cambios, donde solamente es de lectura, excepto el seguimiento que es obligatorio modificar-->
                <div class="mb-3">
